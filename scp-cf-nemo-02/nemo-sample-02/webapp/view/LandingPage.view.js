sap.ui.jsview("scp.cf.nemo-sample-02.view.LandingPage", {
    /**
    ...
    getControllerName: function() {
        return "scp.cf.nemo-sample-02.controller.LandingPage";
    },
    ...
    createContent: function(oController) {
        ...
        var Emp_Form = new sap.ui.layout.form.SimpleForm("Emp_Form", {
            ...
            width: "100%",
            content: [
                new sap.ui.core.Title({text: "Update/Delete Employee Data"}),
        ...
        var Emp_cForm = new sap.ui.layout.form.SimpleForm("Emp_cForm", {
            ...
            width: "100%",
            content: [
                new sap.ui.core.Title({text: "Insert Employee Data"}),
                ...
                new sap.ui.core.Title({text: "Get Employee Data"}),
                lb_sEmpId, ip_sEmpId,
                new sap.m.Button('empsearch', {text: "Search", press: oController.handleSearch}),
                new sap.m.Label('slbl_name', {text: "Name", visible: false}),
                new sap.m.Text('s_txtName', {text: ""}),
                new sap.m.Label('slbl_dob', {text: "DOB", visible: false}),
                new sap.m.Text('s_txtDoB', {text: ""}),
                new sap.m.Label('slbl_desig', {text: "Designation", visible: false}),
                new sap.m.Text('s_txtdesig', {text: ""}),
                new sap.m.Label('slbl_gender', {text: "Gender", visible: false}),
                new sap.m.Text('s_txtgender', {text: ""})
            ]
        });
        ...
        var oIdCol = new sap.ui.table.Column("Coln_1", {
            label: 'Gender',
            template: txt_Gender
        });
        var oIdCol2 = new sap.ui.table.Column("Coln_2", {
            label: 'Id',
            template: txt_EmpId
        });
        ...
        var oIdCol4 = new sap.ui.table.Column("Coln_4", {
            label: "DOB",
            template: txt_DOB
        });
        var oIdCol5 = new sap.ui.table.Column("Coln_5", {
            label: "Desig",
            template: txt_Desig
        });
